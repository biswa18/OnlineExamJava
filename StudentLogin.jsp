 ...
 <div class="container-fluid navbar menubar">
  ...
  <div class="container" style="padding-top:10px;margin-top:5px;padding-bottom:10px;">
  	<div class="row">
  		...
  		<b class="login" >Login to take exam ~~</b><br><br><br><br>
  		
  		 
  		 <div class="form-group">  		  		 
  		 	<input type="email" name="email" class="form-control text"  placeholder="Enter Your Email" style="margin:auto;" required />
  		 </div>
  		 <br>
  		 <div class="form-group">  		 
