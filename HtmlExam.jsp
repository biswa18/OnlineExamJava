...
try {
	        ...
	        session.setAttribute("lang","Html");  

			PreparedStatement ps = con.prepareStatement("select * from ( select * from addques where lang='html' order by dbms_random.value ) where rownum <= 5 ");
