...
<body onload="startTime()"> 
	...
	<div class="col-lg-9">
          <div class="card mt-4">
            <img class="card-img-top img-fluid" style="margin:top;width: 100px;height:100px;" src="c++.png">
            <div class="card-body">            
...
In 1979, Bjarne Stroustrup, a Danish computer scientist, began work on "C with Classes", the predecessor to C++.In 1983, "C with Classes" was renamed to "C++" (++ being the increment operator in C), adding new features that included virtual functions, function name and operator overloading, references, constants, type-safe free-store memory allocation (new/delete), improved type checking, and BCPL style single-line comments with two forward slashes (//). Furthermore, it included the development of a standalone compiler for C++, Cfront.</div>
            <div class="card-body">
              ...
              <li style="text-align:center;"> <a href="https://en.wikipedia.org/wiki/C%2B%2B">C++_Wikipedia</a></li>
              <li style="text-align:center;"> <a href="https://www.geeksforgeeks.org/c-plus-plus/">Geeksforgeeks</a></li>
              <li style="text-align:center;"> <a href="https://www.javatpoint.com/cpp-tutorial">Javatpoint</a></li>              
               </ul>
               <p>Youtube Links:</p>
               <ul style="display: inline-block; text-align:center;">
              <li style="text-align:center;"> <a href="https://www.youtube.com/watch?v=xnh7ip5gpzc&list=PLfVsf4Bjg79DLA5K3GLbIwf3baNVFO2Lq">Learning Lad</a></li>
              <li style="text-align:center;"> <a href="https://www.youtube.com/watch?v=tvC1WCdV1XU&list=PLAE85DE8440AA6B83">TheNewBoston</a></li>
              <li style="text-align:center;"> <a href="https://www.youtube.com/watch?v=Iuo9PpGE04Y&list=PLLYz8uHU480j37APNXBdPz7YzAi4XlQUF">C++ by MySirG</a></li>
